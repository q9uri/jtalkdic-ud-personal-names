...
with bz2.open("./mozcdic-ut-personal-names.txt.bz2", "rt", encoding="utf-8") as f:
    data = f.read()
...
Path("./build/jtalkdic-ud-personal-names-ipadic.csv").write_text("\n".join(out), encoding="utf-8")
...
Path("./build/jtalkdic-ud-personal-names-noacc.csv").write_text("\n".join(out), encoding="utf-8")